...
AUTHORS_URL = (
    "https://raw.githubusercontent.com/ome/ngff-spec/refs/heads/main/authors.yml"
)
...
def main():
    ...
    CONTRIBS_PATH.write_text(
        yaml.dump(contribs_data, sort_keys=False, allow_unicode=True)
    )
